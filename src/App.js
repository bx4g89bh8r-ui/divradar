  ...
  return (
    <div style={{ fontFamily: "'Syne', sans-serif", background: "#0a0e1a", minHeight: "100vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", color: "#e8e8f0" }}>
      ...
      <div style={{ display: "flex", gap: 16, marginBottom: 40, animation: shake ? "shake 0.5s ease" : "none" }}>
        {[0,1,2,3].map(i => (
          <div key={i} style={{ width: 16, height: 16, borderRadius: "50%", background: pin.length > i ? (error ? "#ff5252" : "#3d5afe") : "rgba(255,255,255,0.15)", transition: "all 0.2s" }} />
        ))}
      </div>
      ...
      {error && <div style={{ marginTop: 24, color: "#ff5252", fontSize: 13, fontWeight: 600 }}>PIN incorrecto.</div>}
    </div>
  );
}
...
const BASE_STOCKS = [
  { ticker: "ABBV", yTicker: "ABBV", name: "AbbVie Inc.", country: "US", sector: "Salud", payout: 58, debtEbitda: 1.9, divGrowth5y: 7.2, marketCap: 285000, currency: "USD", lastDiv: 1.55, exDate: "2025-04-14", price: 178.42, priceChange: 0.54, yield: 4.8 },
  { ticker: "ENB", yTicker: "ENB", name: "Enbridge Inc.", country: "CA", sector: "Energía", payout: 65, debtEbitda: 2.8, divGrowth5y: 6.1, marketCap: 78000, currency: "CAD", lastDiv: 0.915, exDate: "2025-05-08", price: 38.21, priceChange: -0.22, yield: 7.1 },
  { ticker: "REP", yTicker: "REP.MC", name: "Repsol S.A.", country: "ES", sector: "Energía", payout: 42, debtEbitda: 1.2, divGrowth5y: 8.4, marketCap: 16200, currency: "EUR", lastDiv: 0.39, exDate: "2025-06-02", price: 14.87, priceChange: 1.1, yield: 5.8 },
  { ticker: "SHEL", yTicker: "SHEL", name: "Shell PLC", country: "GB", sector: "Energía", payout: 36, debtEbitda: 0.8, divGrowth5y: 5.9, marketCap: 195000, currency: "USD", lastDiv: 0.344, exDate: "2025-05-15", price: 32.18, priceChange: 0.78, yield: 4.3 },
  { ticker: "BASF", yTicker: "BASF.DE", name: "BASF SE", country: "DE", sector: "Materiales", payout: 62, debtEbitda: 2.4, divGrowth5y: 5.3, marketCap: 38500, currency: "EUR", lastDiv: 3.4, exDate: "2025-04-28", price: 44.12, priceChange: -1.03, yield: 6.8 },
  { ticker: "T", yTicker: "T", name: "AT&T Inc.", country: "US", sector: "Telecomunicaciones", payout: 53, debtEbitda: 2.9, divGrowth5y: 5.1, marketCap: 144000, currency: "USD", lastDiv: 0.2775, exDate: "2025-07-09", price: 18.74, priceChange: 0.32, yield: 5.6 },
  { ticker: "BHP", yTicker: "BHP", name: "BHP Group Ltd.", country: "AU", sector: "Materiales", payout: 55, debtEbitda: 0.6, divGrowth5y: 9.8, marketCap: 112000, currency: "AUD", lastDiv: 1.46, exDate: "2025-03-04", price: 42.88, priceChange: 2.14, yield: 5.2 },
  { ticker: "VOD", yTicker: "VOD", name: "Vodafone Group", country: "GB", sector: "Telecomunicaciones", payout: 68, debtEbitda: 2.7, divGrowth5y: -2.1, marketCap: 22000, currency: "GBP", lastDiv: 0.045, exDate: "2025-06-18", price: 0.72, priceChange: -0.55, yield: 9.2 },
  { ticker: "VZ", yTicker: "VZ", name: "Verizon Comm.", country: "US", sector: "Telecomunicaciones", payout: 56, debtEbitda: 2.8, divGrowth5y: 2.0, marketCap: 169000, currency: "USD", lastDiv: 0.665, exDate: "2025-07-09", price: 40.87, priceChange: -0.18, yield: 6.4 },
  { ticker: "NEE", yTicker: "NEE", name: "NextEra Energy", country: "US", sector: "Utilities", payout: 61, debtEbitda: 2.5, divGrowth5y: 10.3, marketCap: 139000, currency: "USD", lastDiv: 0.515, exDate: "2025-05-29", price: 70.12, priceChange: 0.87, yield: 4.1 },
  { ticker: "IBE", yTicker: "IBE.MC", name: "Iberdrola S.A.", country: "ES", sector: "Utilities", payout: 52, debtEbitda: 2.3, divGrowth5y: 6.7, marketCap: 84000, currency: "EUR", lastDiv: 0.31, exDate: "2025-04-07", price: 14.04, priceChange: 0.43, yield: 4.4 },
  { ticker: "ING", yTicker: "INGA.AS", name: "ING Groep N.V.", country: "NL", sector: "Financiero", payout: 45, debtEbitda: 1.8, divGrowth5y: 12.1, marketCap: 52000, currency: "EUR", lastDiv: 0.756, exDate: "2025-05-20", price: 16.22, priceChange: 1.44, yield: 7.3 },
  { ticker: "AZN", yTicker: "AZN", name: "AstraZeneca", country: "GB", sector: "Salud", payout: 82, debtEbitda: 3.8, divGrowth5y: 1.0, marketCap: 221000, currency: "USD", lastDiv: 1.0, exDate: "2025-03-20", price: 128.44, priceChange: 0.24, yield: 2.1 },
  { ticker: "TD", yTicker: "TD", name: "Toronto-Dom. Bank", country: "CA", sector: "Financiero", payout: 48, debtEbitda: 1.4, divGrowth5y: 7.9, marketCap: 98000, currency: "CAD", lastDiv: 1.02, exDate: "2025-04-02", price: 55.34, priceChange: -0.88, yield: 5.1 },
  { ticker: "AEP", yTicker: "AEP", name: "Amer. Elec. Power", country: "US", sector: "Utilities", payout: 64, debtEbitda: 2.9, divGrowth5y: 6.2, marketCap: 52000, currency: "USD", lastDiv: 0.88, exDate: "2025-05-08", price: 96.44, priceChange: 0.11, yield: 4.6 },
  { ticker: "ENEL", yTicker: "ENEL.MI", name: "Enel SpA", country: "IT", sector: "Utilities", payout: 57, debtEbitda: 2.6, divGrowth5y: 5.8, marketCap: 65000, currency: "EUR", lastDiv: 0.43, exDate: "2025-01-22", price: 7.12, priceChange: 0.55, yield: 5.9 },
  { ticker: "WES", yTicker: "WES", name: "Western Midstream", country: "US", sector: "Energía", payout: 62, debtEbitda: 2.7, divGrowth5y: 11.2, marketCap: 14800, currency: "USD", lastDiv: 0.875, exDate: "2025-05-01", price: 37.55, priceChange: 1.25, yield: 8.4 },
  { ticker: "BNS", yTicker: "BNS", name: "Bank of Nova Scotia", country: "CA", sector: "Financiero", payout: 54, debtEbitda: 1.6, divGrowth5y: 5.4, marketCap: 67000, currency: "CAD", lastDiv: 1.06, exDate: "2025-04-02", price: 56.78, priceChange: -0.31, yield: 6.2 },
  { ticker: "HRZN", yTicker: "HRZN", name: "Horizon Technology", country: "US", sector: "Financiero", payout: 88, debtEbitda: 3.5, divGrowth5y: 1.2, marketCap: 350, currency: "USD", lastDiv: 0.11, exDate: "2025-04-15", price: 10.22, priceChange: -1.02, yield: 12.1 },
  { ticker: "TOTB", yTicker: "TTE", name: "TotalEnergies SE", country: "FR", sector: "Energía", payout: 44, debtEbitda: 1.1, divGrowth5y: 6.3, marketCap: 142000, currency: "EUR", lastDiv: 0.795, exDate: "2025-06-23", price: 62.34, priceChange: 0.67, yield: 5.3 },
];
...
function matchesFilters(stock, filters) {
  ...
  if ((stock.yield || 0) < filters.yieldMin) return false;
...
function DividendScreener() {
  ...
  const [dataStatus, setDataStatus] = useState("simulado");
  ...
  const fetchRealData = useCallback(async () => {
    try {
      ...
      setStocks(prev => prev.map(s => {
        const q = quotes[s.yTicker];
        if (!q || !q.price) return s;
        return { ...s, price: +q.price.toFixed(2), priceChange: +q.priceChange.toFixed(2) };
      }));
      setLastUpdated(new Date());
      setDataStatus("real");
    } catch {
      setDataStatus("simulado");
    }
  }, []);

  useEffect(() => {
    fetchRealData();
    intervalRef.current = setInterval(fetchRealData, 5 * 60 * 1000);
    ...
    alerts.forEach(alert => {
      ...
      if (triggered) {
        ...
        if (!triggeredAlerts.includes(key)) {
          ...
          setNotification({ message: `⚡ ${alert.ticker}: ${alert.metric} es ${alert.condition} ${alert.value}`, type: "alert" });
  ...
  const exportToExcel = () => {
    ...
    if (isIOS) {
      ...
      showNotif("📂 Safari → 'Guardar en Archivos'", "success");
    } else {
      XLSX.writeFile(wb, `DivRadar_Export_${date}.xlsx`);
  ...
  const addAlert = () => {
    ...
    showNotif("✅ Alerta creada", "success");
  };
    ...
    try {
      const response = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          messages: [{ role: "user", content: `Eres un analista financiero experto en dividendos. Analiza esta acción en español: Ticker: ${stock.ticker} | Empresa: ${stock.name} | Yield: ${stock.yield.toFixed(2)}% | Payout: ${stock.payout}% | Deuda/EBITDA: ${stock.debtEbitda}x | Div. Growth 5y: ${stock.divGrowth5y}% | Precio: ${stock.price} ${stock.currency}. Proporciona: 1) Evaluación del dividendo, 2) Fortalezas (3 bullets), 3) Riesgos (2 bullets), 4) Veredicto. Usa markdown.` }]
        })
      });
      const data = await response.json();
      setAiInsight(data.content?.map(b => b.text || "").join("") || "No se pudo obtener análisis.");
    ...
    <div style={{ fontFamily: "'Syne', sans-serif", background: "#0a0e1a", minHeight: "100vh", color: "#e8e8f0" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        input, select { background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.12); color: #e8e8f0; border-radius: 8px; padding: 8px 12px; font-family: 'Syne',sans-serif; font-size: 13px; outline: none; width: 100%; }
        ...
        .ai-text h3 { color: #c3cff5; font-size: 14px; margin: 12px 0 6px; }
      ...
      <div style={{ borderBottom: "1px solid rgba(255,255,255,0.07)", padding: "16px 24px" }} className="glass">
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            ...
            <div>
              <div style={{ fontSize: 20, fontWeight: 800 }}>DivRadar <span style={{ color: "#3d5afe" }}>Pro</span></div>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, fontSize: 12, color: "#778" }}>
              ...
              <span style={{ fontSize: 10, padding: "2px 6px", borderRadius: 4, background: dataStatus === "real" ? "rgba(0,230,118,0.15)" : "rgba(255,193,7,0.15)", color: dataStatus === "real" ? "#00e676" : "#ffc107" }}>
                {dataStatus === "real" ? "Yahoo Finance" : "Simulado"}
              </span>
            </div>
      ...
      <div style={{ maxWidth: 1400, margin: "0 auto", padding: "24px" }}>
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(160px,1fr))", gap: 12, marginBottom: 24 }}>
          {[
            ...
            { label: "Universo total", value: BASE_STOCKS.length, icon: "🌍", color: "#7c4dff" },
          ].map((stat, i) => (
            <div key={i} className="glass" style={{ borderRadius: 12, padding: 16, display: "flex", alignItems: "center", gap: 12 }}>
              <div style={{ fontSize: 22 }}>{stat.icon}</div>
              <div>
                <div style={{ fontSize: 20, fontWeight: 800, color: stat.color, fontFamily: "'JetBrains Mono',monospace" }}>{stat.value}</div>
                <div style={{ fontSize: 11, color: "#556", fontWeight: 600 }}>{stat.label}</div>
              </div>
            </div>
          ))}
        </div>
              ...
              <thead>
                <tr style={{ background: "rgba(61,90,254,0.08)", borderBottom: "1px solid rgba(255,255,255,0.08)" }}>
                  {[
                    ...
                    <th key={col.key} style={{ padding: "12px 16px", textAlign: "left", fontWeight: 700, fontSize: 11, color: "#7788aa", letterSpacing: "0.08em", whiteSpace: "nowrap", cursor: "pointer" }}
              ...
              <tbody>
                {filteredStocks.length === 0 ? (
                  ...
                  <tr key={stock.ticker} className="ticker-row">
                    ...
                    <td style={{ padding: "12px 16px" }}>
                      <button onClick={() => getAiInsight(stock)} style={{ background: "linear-gradient(135deg,rgba(61,90,254,0.2),rgba(124,77,255,0.2))", border: "1px solid rgba(61,90,254,0.3)", color: "#c3cff5", borderRadius: 8, padding: "5px 12px", cursor: "pointer", fontSize: 12, fontFamily: "'Syne',sans-serif", fontWeight: 600 }}>✨ AI</button>
                    </td>
                  </tr>
                ))}
              </tbody>
        ...
        <div style={{ marginTop: 16, fontSize: 11, color: "#445", textAlign: "center" }}>
          📡 Precios vía Yahoo Finance (~15 min retraso). Indicador amarillo = usando datos base.
        </div>
      </div>
          ...
          <div className="glass-bright" style={{ borderRadius: 20, padding: 28, width: "100%", maxWidth: 560, maxHeight: "90vh", overflowY: "auto" }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              {[
                ...
                { key: "debtEbitdaMax", label: "Deuda/EBITDA máx.", step: 0.5 },
        ...
        <div className="modal-bg" onClick={() => setShowAlertModal(false)}>
          <div className="glass-bright" style={{ borderRadius: 20, padding: 28, width: "100%", maxWidth: 520, maxHeight: "90vh", overflowY: "auto" }} onClick={e => e.stopPropagation()}>
            ...
            <div style={{ background: "rgba(61,90,254,0.08)", borderRadius: 12, padding: 16, marginBottom: 20 }}>
              <div style={{ fontSize: 12, fontWeight: 700, color: "#7788aa", marginBottom: 12 }}>NUEVA ALERTA</div>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10, marginBottom: 10 }}>
                <div><label>Ticker</label><input placeholder="ej: ABBV" value={newAlert.ticker} onChange={e => setNewAlert(p=>({...p,ticker:e.target.value.toUpperCase()}))} /></div>
